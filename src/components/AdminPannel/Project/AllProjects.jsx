...
const AllProjects = () => {
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get('http://bhartiyabiotech.ap-south-1.elasticbeanstalk.com/products');
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://bhartiyabiotech.ap-south-1.elasticbeanstalk.com/products/${id}`, {
        headers: {
