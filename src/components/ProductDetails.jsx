    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `http://bhartiyabiotech.ap-south-1.elasticbeanstalk.com/productf/${productId}`
        );
  ...
  const handleAddToCart = async () => {
    try {
      ...
      const response = await axios.post(
        `http://bhartiyabiotech.ap-south-1.elasticbeanstalk.com/cart/${userId}/${varientsId}/${varientsPrice}`,
        {
          quantity,
        },
        {
